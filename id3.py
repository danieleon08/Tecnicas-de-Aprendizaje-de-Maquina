...
# ID3 → Decision tree con criterio "entropy"
...
df = pd.read_csv("heart_disease.csv")   # Ajusta ruta si es necesario

print("Primeras filas del dataset:")
print(df.head())        # display() → print()

print("\nInformación del dataset:")
print(df.info())

print("\nDescripción estadística:")
print(df.describe())    # display() → print()
...
# Variables predictoras (quitamos columnas no deseadas)
...
y_prob = id3.predict_proba(X_test)[:, 1]
